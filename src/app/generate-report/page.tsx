...
function GenerateReportContent() {
  ...
  const [status, setStatus] = useState<'verifying' | 'verified' | 'failed' | 'generating'>('verifying');
  ...
  const verifyPaymentAndStartAnalysis = async () => {
    try {
      ...
      if (result.success && result.status === 'completed') {
        setStatus('verified');
        setMessage('Payment verified successfully! Starting your analysis...');
        console.log('[GENERATE REPORT] Payment verified, starting analysis');
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        {/* Status Display */}
        {status !== 'generating' && <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 mb-8">
          {status === 'verifying' && (
