...
export default function ProtectedAuditRoute({ children, pageType }: ProtectedAuditRouteProps) {
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="max-w-md w-full mx-4">
          {/* <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Please sign in to access the {pageType} page audit</p>
          </div> */}
        ...
        <div className="max-w-md w-full mx-4">
          <div className="text-center mb-8">
            ...
            <div className="space-y-3">
              ...
              <button
                onClick={() => window.location.href = 'mailto:support@fixmystore.com'}
